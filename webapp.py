...
def render_response():
    ...
    return render_template('response.html', response = get_state_options(), default = state_selected, responseTwo = get_county_options(state_selected), fact = average_median_houseold_income(state_selected))
